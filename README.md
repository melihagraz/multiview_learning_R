...
This project provides a structure of folders and files for Multi-view Learning ACCORD Project. You are going to see 3 different codes  like ```base_ML_.R```, ```self_ML_.R``` and ```CO_ML_.R```. 
