...
MultiViewCoTraininig<-
  function(lab, unlabeled, method = c("nb", "rf"), train_prob = 0.8,
    ...
    plot_Co( SpecCV_fin, name = "Specificity" , feature_sel = feature_sel,
             method =  method, format = ".pdf" )
    # ppv_plot
    ...
    plot_Co( PPVCV_fin, name = "PPV" , feature_sel = feature_sel,
             method =  method, format = ".pdf" )
    # npv_plot
    ...
    plot_Co( NPVCV_fin,  name = "NPV" ,  feature_sel = feature_sel,
             method =  method,  format = ".pdf" )
    # ACC
    ...
    plot_Co( AccCV_fin, name = "Accuracy" ,
    ...
    plot_Co( BalAccCV_fin, name = "BalancedAccuracy" ,
             feature_sel = feature_sel, method =  method, format = ".pdf" )
    #--------------------------------------------------------------------------- plot TP TN
    # TP
    ...
    plot_Co2( TN_fin, name = "TN" , feature_sel = feature_sel,
              method =  method, format = ".pdf" )
    ...
    plot_Co2( FP_fin, name = "FP" , feature_sel = feature_sel,
              method =  method, format = ".pdf" )
    #FN
    ...
    plot_Co2( FN_fin, name = "FN" , feature_sel = feature_sel,
              method =  method, format = ".pdf" )
    #-----------------------------------------------------------TP-TN-FP-FN
